                                ...
                                <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                    <div class="card-header pb-1">
                                        <div class="card-title">
                                            <h4 class="text-center mb-2">ثبت نام کارفرما</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form action="/api/V1/auth/employer_register" id="RegisterEmployer" method="post">
                                                @csrf
                                                <div class="form-row">
                                                    <div class="form-group col-md-6 mb-50">
                                                        <label for="inputfirstname4">نام انگلیسی شرکت</label>
                                                        <input type="text" class="form-control" name="company_english" id="inputfirstname4" placeholder="نام انگلیسی شرکت">
                                                    ...
                                                    <div class="form-group col-md-6 mb-50">
                                                        <label for="inputlastname4">نام فارسی شرکت</label>
                                                        <input type="text" class="form-control" id="inputlastname4" name="company_persian" placeholder="نام فارسی شرکت">
                                                    <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="form-group mb-50">
                                                    <label for="inputfirstname4">نام و نام خانوادگی مدیرعامل</label>
                                                    <input type="text" class="form-control" id="inputfirstname4" name="Fname_Lname_manager" placeholder="نام و نام خانوادگی مدیرعامل">
                                                    <span class="invalid-feedback" role="alert">
                                                            <strong id="FnameLnamemanagerss"></strong>
                                                    </span>
                                                </div>
                                                <div class="form-group mb-50">
                                            ...
                                            <hr>
                                            <div class="text-center"><small class="mr-25">حساب کاربری دارید؟</small><a href="auth-login.html"><small>ورود</small> </a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                error: function (error) {
                    ...
                    if (obj.errors.Fname_Lname_manager === undefined) {
                        document.getElementById('FnameLnamemanagerss').innerHTML = " "

                    } else {
                        document.getElementById('FnameLnamemanagerss').innerHTML = obj.errors.Fname_Lname_manager
