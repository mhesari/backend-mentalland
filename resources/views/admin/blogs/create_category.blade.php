...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">افزودن دسته بندی
        </li>
    </ol>
@endsection
@section('title')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">افزودن دسته بندی مقالات</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" id="saveFaq" action="/api/V1/admin/category_blog_save">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
