...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">ویرایش مقالات
        </li>
    </ol>
@endsection
@section('title')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش  مقالات</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" id="saveFaq" action="/api/V1/admin/blogs_update/{{ $blogs->id }}">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-column" value="{{ $blogs-> title_blog}}" class="form-control" placeholder="عنوان مقاله" name="title_blog">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-column" value="{{ $blogs-> slug}}" class="form-control" placeholder="مسیر دستیابی به مقاله" name="slug">
                                            ...
                                            <div class="form-label-group">
                                                <select name="category_id" class="form-control" id="">
                                                    ...
                                                    @foreach($category as $categores)
                                                        <option value="{{ $categores->id }}" @if($blogs->category_id == $categores->id) selected @endif>{{ $categores->title_category }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <textarea name="content_blog" class="form-control" id="" cols="30" rows="10">{{ $blogs->content_blog }}</textarea>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-column"  class="form-control" value="{{ $blogs->meta_description }}" placeholder="متا سئو" name="meta_description">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-column"  class="form-control" value="{{ $blogs->keyword_description }}" placeholder="کلمات کلیدی" name="keyword_description">
