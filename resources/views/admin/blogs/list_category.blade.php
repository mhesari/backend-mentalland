...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">لیست دسته بندی مقالات
        </li>
    </ol>
@endsection
@section('title')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"/api/V1/admin/category_blog_list",
        ...
        function edit_category(id){
            location.href='/admin/category-blog-edit/'+id;
        }
        function delete_faq(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/api/V1/admin/category_blog_delete/"+id,
                        type: "DELETE",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="card-title">لیست دسته بندی مقالات</h4>
                            </div>
                            <div class="col-lg-6">
                                <a href="/admin/category-blog-create" class="btn btn-info float-right">افزودن دسته بندی مقالات</a>
                            </div>
                        </div>
                    </div>
