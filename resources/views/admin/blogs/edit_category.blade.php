...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item"><a href="/admin/category-blog-list/">لیست دسته بندی مقالات</a>
        </li>
        <li class="breadcrumb-item active">ویرایش دسته بندی
        </li>
    </ol>
@endsection
@section('title')
    ویرایش دسته بندی مقالات
@endsection
@section('script')
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                location.href='/admin/category-blog-list'
                            }
                        })
                    },
                    error: function (error) {
                        ...
                        if (obj.errors.title_category === undefined) {
                            document.getElementById('titlecategoryss').innerHTML = " "

                        } else {
                            document.getElementById('titlecategoryss').innerHTML = obj.errors.title_category
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش دسته بندی مقالات</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" id="saveFaq" action="/api/V1/admin/category_blog_update/{{ $cateogry->id }}">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-column"  class="form-control" value="{{ $cateogry->title_category }}" placeholder="عنوان دسته بندی" name="title_category">
                                                <label for="first-name-column">عنوان دسته بندی</label>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong id="title_category"></strong>
                                                </span>
                                            </div>
                                        </div>
