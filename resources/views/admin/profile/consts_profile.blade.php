...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">پروفایل مشاور
        </li>
    </ol>
@endsection
@section('title')
            ...
            $('#UpdateAdmin').on('submit', (function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                location.href = "/admin/profile_const"
                            }
                        })
                    },
                    error: function (error) {
                        ...
                        if (obj.errors.codemeli === undefined) {
                            document.getElementById('codemeliss').innerHTML = " "

                        } else {
                            document.getElementById('codemeliss').innerHTML = obj.errors.codemeli
                        ...
                        if (obj.errors.degree_education === undefined) {
                            document.getElementById('degreeeducations').innerHTML = " "

                        } else {
                            document.getElementById('degreeeducations').innerHTML = obj.errors.degree_education
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="tab-content">
                                        <form action="/api/V1/const/const_profile" id="UpdateAdmin" method="post">
                                            @csrf
                                            {{ method_field('PUT') }}
                                            <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                                <div class="media">
                                                    <a href="">
                                                        <img @if(!empty($profile->avatar)) src="../../image/users/cons/{{ $profile->avatar }}" @else src="../../panel/assets/images/portrait/small/avatar-s-16.jpg" @endif  class="rounded mr-75" alt="profile image" height="64" width="64">
                                                    </a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control text-left" placeholder="نام خانوادگی" value="{{ $profile->Lname }}" name="Lname">
                                                                <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label>کدملی</label>
                                                                <input type="text" class="form-control text-left" placeholder="کدملی" value="{{ $profile->national_code }}" name="codemeli">
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong id="codemeliss"></strong>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label>دانشگاه</label>
                                                                <input type="text" class="form-control text-left" placeholder="دانشگاه" value="{{ $profile->university }}" name="university">
                                                                <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label>اپلود اخرین مدرک تحصیلی</label>
                                                                <input type="file" class="form-control text-left" placeholder="اپلود اخرین مدرک تحصیلی"  name="degree_education">
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong id="degreeeducations"></strong>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
