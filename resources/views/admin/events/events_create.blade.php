...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">افزودن رویداد
        </li>
    </ol>
@endsection
@section('title')
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" id="saveFaq" action="/api/V1/admin/events_create">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-column"  class="form-control" placeholder="عنوان رویداد" name="title_event">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="last-name-column" class="form-control" placeholder="مدرس دوره" name="teacher_events">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="last-name-column" class="form-control" placeholder="ساعت برگزاری دوره" name="time_events">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <input type="number" id="last-name-column" class="form-control" placeholder="تعداد مجاز ثبت نام" name="view_register">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="last-name-column" class="form-control" placeholder="مبلغ دوره" name="price_event">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="last-name-column" class="form-control" placeholder="مبلغ تخفیف دوره" name="price_gift_events">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <textarea name="description_events" class="form-control" id="" cols="30" rows="10"></textarea>
