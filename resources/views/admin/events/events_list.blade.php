...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">لیست رویداد
        </li>
    </ol>
@endsection
@section('title')
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "columns":[
                    ...
                    {
                        "render": function (data, type, JsonResultRow, meta) {
                            return '<a href="../../../image/events/'+JsonResultRow.thumbnail_events+'"><img src="../../../image/events/'+JsonResultRow.thumbnail_events+'" style="width: 80px;height: 80px"></a>';
                        },
                    },
                    {data:'date_events'},
        ...
        function edit_events(id){
            location.href='/admin/event-edit/'+id;
        }
        function delete_faq(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/api/V1/admin/events_delete/"+id,
                        type: "DELETE",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="card-title">لیست رویداد</h4>
                            </div>
                            <div class="col-lg-6">
                                <a href="/admin/event-create" class="btn btn-info float-right">افزودن رویداد</a>
                            </div>
                        </div>
                    </div>
