...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">ویرایش اگهی
        </li>
    </ol>
@endsection
@section('script')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش اگهی</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" id="saveFaq" action="/api/V1/employer/adversting_update/{{ $adv->id }}">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <input type="text" id="first-name-column" value="{{ $adv->ad_title }}"  class="form-control" placeholder="عنوان اگهی" name="ad_title">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <select name="ad_category" class="form-control" id="">
                                                    ...
                                                    <option value="artistic" @if($adv->ad_category == "artistic") selected @endif>هنری</option>
                                                    <option value="Business"  @if($adv->ad_category == "Business") selected @endif>تجارت</option>
                                                    <option value="Psychology"  @if($adv->ad_category == "Psychology") selected @endif>روانشناسی</option>
                                                </select>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <select name="Type_cooperation" class="form-control" id="">
                                                    ...
                                                    <option value="full_time"  @if($adv->Type_cooperation == "full_time") selected @endif>تمام وقت</option>
                                                    <option value="Part_time" @if($adv->Type_cooperation == "Part_time") selected @endif>پاره وقت</option>
                                                    <option value="remote" @if($adv->Type_cooperation == "remote") selected @endif>دورکاری</option>
                                                </select>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-label-group">
                                                <select name="minimum_salary" class="form-control" id="">
                                                    ...
                                                    <option value="1 تا 3 میلیون" @if($adv->minimum_salary == "1 تا 3 میلیون") selected @endif>1 تا 3 میلیون</option>
                                                    <option value="4 تا 6 میلیون" @if($adv->minimum_salary == "4 تا 6 میلیون") selected @endif>4 تا 6 میلیون</option>
                                                    <option value="بیش از 8 میلیون" @if($adv->minimum_salary == "بیش از 8 میلیون") selected @endif>بیش از 8 میلیون</option>
                                                </select>
                                                <label for="last-name-column">نوع همکاری</label>
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="form-label-group">
                                                <select name="province_id" class="form-control js-example-basic-single" id="provinceID">
                                                    ...
                                                    @foreach($province as $provinces)
                                                        <option value="{{ $provinces->id }}" @if($provinces->id == $adv->province_id) selected @endif>{{ $provinces->name }}</option>
                                                    @endforeach
                                                </select>
                                                <label for="last-name-column">نوع همکاری</label>
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <select name="Relevant_work_experience" class="form-control" >
                                                    ...
                                                    <option value="3year" @if($adv->Relevant_work_experience == "3year") selected @endif>سه سال</option>
                                                    <option value="3_6year" @if($adv->Relevant_work_experience == "3_6year") selected @endif>سه تا شش سال</option>
                                                    <option value="6+year" @if($adv->Relevant_work_experience == "6+year") selected @endif>بیش از شش سال</option>
                                                </select>
                                                <label for="last-name-column">نوع همکاری</label>
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-label-group">
                                                <textarea name="ad_content" class="form-control" id="" cols="30" rows="10">{{ $adv->ad_content }}</textarea>
                                                <label for="last-name-column">نوع همکاری</label>
                                                <span class="invalid-feedback" role="alert">
