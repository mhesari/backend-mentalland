...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">لیست سوالات متداول
        </li>
    </ol>
@endsection
@section('title')
        ...
        function delete_faq(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/api/V1/admin/faqs_delete/"+id,
                        type: "DELETE",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
                ...
                <div class="card">
                    <div class="card-header">
                      <div class="row">
                          ...
                          <div class="col-lg-6">
                              <a href="/admin/faq_create" class="btn btn-info float-right">افزودن سوالات متداول</a>
                          </div>
                      </div>
                    </div>
