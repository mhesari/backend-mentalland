...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">لیست دسته بندی مشاور
        </li>
    </ol>
@endsection
@section('title')
    لیست دسته بندی مشاور
@endsection
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"/api/V1/admin/category_consts_list",
                ...
                "columns":[
                    ...
                    {data:'title_category'},
                    {
                        ...
                        "render": function ( data, type, full, meta ) {
                            return "<button onclick='subcategory_list("+full.id+")' style='background: darkred;border: none;width: 35px;height: 35px;border-radius: 20%;color: white;margin-left: 4px;'><span class='action-edit'><i class='bx bxs-file'></i></span></button><button onclick='delete_category("+full.id+")' style='background: darkred;border: none;width: 35px;height: 35px;border-radius: 20%;color: white'><span class='action-edit'><i class='bx bxs-trash'></i></span></button>";
                        }
                    }
                ],
        ...
        function subcategory_list(id){
            location.href='/admin/subcategory-const-list/'+id;
        }
        ...
        function delete_category(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/api/V1/admin/delete_category/"+id,
                        type: "DELETE",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="card-title">لیست دسته بندی مشاور</h4>
                            </div>
                            <div class="col-lg-6">
                                <a href="/admin/category-const-create" class="btn btn-info float-right">افزودن دسته بندی مشاور</a>
                            </div>
                        </div>
                    </div>
