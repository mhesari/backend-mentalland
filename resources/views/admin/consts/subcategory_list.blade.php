    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"/api/V1/admin/subcategory_consts_list/{{ $id }}",
                ...
                "columns":[
                    ...
                    {data:'subcategory_title'},
                    {
                        ...
                        "render": function ( data, type, full, meta ) {
                            return "<button onclick='delete_category("+full.id+")' style='background: darkred;border: none;width: 35px;height: 35px;border-radius: 20%;color: white'><span class='action-edit'><i class='bx bxs-trash'></i></span></button>";
                        }
                    }
                ],
        ...
        function delete_category(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/api/V1/admin/subcategory_consts_delete/"+id,
                        type: "DELETE",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="card-title">لیست زیردسته بندی مشاور</h4>
                            </div>
                            <div class="col-lg-6">
                                <a href="/admin/subcategory-const-create" class="btn btn-info float-right">افزودن زیر دسته بندی مشاور</a>
                            </div>
                        </div>
                    </div>
