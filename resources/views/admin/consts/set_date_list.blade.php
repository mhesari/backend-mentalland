...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">لیست تاریخ و زمان
        </li>
    </ol>
@endsection
@section('title')
    لیست ست کردن زمان مشاور
@endsection
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"/api/V1/const/set_date_time_list",
        ...
        function delete_faq(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/api/V1/const/set_date_time_delete/"+id,
                        type: "DELETE",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
                        success: function (response) {
                            if(response.status == true){
                                ...
                                location.href='/admin/set-const-list/'
                            }else{
                                Swal.fire({
                                    title: 'هشدار',
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">لیست زمان مشاور </h4>
                    </div>
