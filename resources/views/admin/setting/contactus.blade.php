    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"/api/V1/admin/contactus_list",
                ...
                "columns":[
                    ...
                    {data:'description'},
                    {
                        ...
                        "render": function ( data, type, full, meta ) {
                            return "<button onclick='delete_users("+full.id+")' style='background: darkred;border: none;width: 35px;height: 35px;border-radius: 20%;color: white'><span class='action-edit'><i class='bx bxs-trash'></i></span></button>";
                        }
                    }
                ],
        ...
        function delete_users(id){
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/api/V1/admin/contactus_delete/"+id,
                        type: "DELETE",
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader ("Authorization", "Bearer " + token);
                        },
                        success: function (response) {
                            if(response.status == true){
                                ...
                                location.href='/admin/contact-us/'
                            }else{
                                Swal.fire({
                                    title: 'هشدار',
