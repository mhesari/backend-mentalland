...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">لیست کارفرمایان
        </li>
    </ol>
@endsection
@section('title')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"/api/V1/admin/employer_list",
                ...
                "columns":[
                    ...
                    {data:'company_english'},
                    {data:'Fname_Lname_manager'},
                    {
                        "render": function (data, type, JsonResultRow, meta) {
                            return '<a href="../../../image/users/employer/profile/'+JsonResultRow.company_logo+'"><img src="../../../image/users/employer/profile/'+JsonResultRow.company_logo+'" style="width: 80px;height: 80px"></a>';
                        },
                    },
                    {data:'phone_number'},
                    {data:'email'},
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">لیست کارفرمایان</h4>
                    </div>
                        ...
                        <div class="card-body card-dashboard">
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="tblData">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>نام فارسی شرکت</th>
                                        <th>نام انگلیسی شرکت</th>
