...
@section('breadcrumb')
    <ol class="breadcrumb p-0 mb-0">
        ...
        <li class="breadcrumb-item active">لیست مشاوران
        </li>
    </ol>
@endsection
@section('title')
        ...
        $(document).ready(function() {
            ...
            $('#tblData').DataTable({
                ...
                "columns":[
                    ...
                    {
                        "render": function (data, type, JsonResultRow, meta) {
                            return '<a href="../../../image/users/cons/'+JsonResultRow.avatar+'"><img src="../../../image/users/cons/'+JsonResultRow.avatar+'" style="width: 80px;height: 80px"></a>';
                        },
                    },
